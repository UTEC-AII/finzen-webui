...
const DICT: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "register.timezone": "País / zona horaria",
    ...
    "profile.timezone": "País / zona horaria",
    ...
    "assistant.greeting": "¿En qué puedo ayudarte con tus finanzas?",
    ...
    "assistant.reindex": "Re-indexar movimientos",
    "assistant.reindexing": "Re-indexando...",
  ...
  en: {
    ...
    "register.timezone": "Country / time zone",
    ...
    "profile.timezone": "Country / time zone",
    "profile.savingsGoal": "Monthly savings goal",
    "profile.save": "Save changes",
    "profile.updated": "Profile updated successfully.",

    "assistant.title": "Smart query",
    "assistant.greeting": "How can I help you with your finances?",
    ...
    "assistant.reindex": "Re-index records",
    "assistant.reindexing": "Re-indexing...",
